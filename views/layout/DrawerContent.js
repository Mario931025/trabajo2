            ...
            {/* <DrawerItemList {...props} /> */}
                ...
                <ImageBackground source={MenuBack} style={styles.image}>
                    ...
                    <View style={styles.menuItemView}>
                        ...
                        <Text style={styles.menuItem} onPress={() => props.navigation.navigate('Register')}>Recetas guardadas</Text>
                    </View>
                    <View style={styles.menuItemView}>
                    ...
                    <View style={styles.menuItemViewLast}>
                        ...
                        <Text style={styles.menuItem} onPress={() => props.navigation.navigate('Register')}>Perfil</Text>
                    </View>
                </ImageBackground>
